    ...
    <header>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="http://localhost/TP-web_avancee/livre-index.php">Modification</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="http://localhost/TP-web_avancee/auteur-index.php">Modification</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="http://localhost/TP-web_avancee/maison-edition-index.php">Modification</a>
            </div>
        </div>
    </header>
